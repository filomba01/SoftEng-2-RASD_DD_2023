...
\end{figure}
\pagebreak
Once finished with the \textit{Evaluation Server}, the implementation and testing will focus on both the \textit{Code Evaluator} and the \textit{Static Analyzer}, a \textit{driver} will be used to simulate the \texit{Evaluation Controller}
\begin{figure}[H]
