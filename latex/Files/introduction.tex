...
\begin{table}[H]
  \begin{tabular}{|l|l|}
    ...
    \hline
    G12 & Assign Points to STs Based on Code Evaluation \\
    \hline
    G13 & Allow STs and ED to View Rankings of Competition \\
    \hline
    G14 & Allow STs to View Rankings of battles only in competition for which are subscribed \\
    \hline
