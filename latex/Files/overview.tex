...
\begin{table}[H]
  \begin{tabular}{|l|l|}
    ...
    \hline
    DA1 & ST owns a computer \\
    \hline
    DA2 & ST has a GitHub account \\
    \hline
    ...
    \hline
    DA6 & ED owns a computer \\
    \hline
    DA7 & ED writes correct tests \\ 
    \hline
    DA8 & ST knows username of other STs that want to invite in a team \\
    \hline
    DA9 & STs has an internet connection \\
    \hline
    DA10 & EDs has an internet connection \\
    \hline
    DA11 & ST write code only in the programming languages supported by the platform \\
    \hline
    DA12 & EDs write tests only in the programming languages supported by the platform \\
    \hline
    DA13 & ED knows the email of the other EDs he wants to invite managing a competition \\
    \hline
